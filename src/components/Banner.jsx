    ...
    <div className="md:px-12 p-4 max-w-screen-2xl mx-auto mt-24 ">
        <div className='gradientBg rounded-xl rounded-br-[80px] px-4 py-9'>
            ...
            <div
             ...
             <div
                className='md:w-3/5 pr-5'>
                    <h2 className='md:text-7xl text-xl font-bold text-white mb-6 leading-relaxed'> شفاء للرعايه الطبيه</h2>
            ...
            ونفتخر بتقديم معايير جديدة في مجال الرعاية الصحية المنزلية. 
                    ...
                    <div className='space-x-6 space-y-4'>
                        <a href="https://wa.me/+20 128 490 4444" target="_blank" rel="noreferrer" className="btn-contact-us">للتواصل معنا</a>
                    </div>
                </div>
            </div>
        </div>
